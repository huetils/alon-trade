...
class hyperliquid(Exchange, ImplicitAPI):
    ...
    def cancel_orders_for_symbols(self, orders: List[CancellationRequest], params=...): # -> Any:
        """
    ...
    def edit_order(self, id: str, symbol: str, type: str, side: str, amount: Num = ..., price: Num = ..., params=...): # -> Order:
        """
        edit a trade order
