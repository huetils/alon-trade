...
from ccxt.base.types import Balances, FundingRate, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade
...
class poloniexfutures(Exchange, ImplicitAPI):
    ...
    async def fetch_l3_order_book(self, symbol: str, limit: Int = ..., params=...): # -> Coroutine[Any, Any, OrderBook]:
        """
