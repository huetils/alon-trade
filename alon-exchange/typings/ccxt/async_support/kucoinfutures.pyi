...
from ccxt.base.types import Balances, Currency, DepositAddress, FundingRate, Int, Leverage, LeverageTier, MarginMode, MarginModification, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, Transaction, TransferEntry
...
class kucoinfutures(kucoin, ImplicitAPI):
 ...
 ----------------- Exchange Specific Parameters -----------------
    ...
    async def cancel_order(self, id: str, symbol: Str = ..., params=...): # -> None:
        """
    ...
    async def cancel_all_orders(self, symbol: Str = ..., params=...): # -> None:
        """
