...
class idex(ccxt.async_support.idex):
    ...
    async def subscribe(self, subscribeObject, messageHash, subscription=...):
        ...
    ...
    def handle_subscribe_message(self, client: Client, message): # -> None:
        ...
    ...
    def handle_order_book_message(self, client: Client, message, orderbook): # -> None:
        ...
    ...
    async def authenticate(self, params=...): # -> str | dict[str, dict[str, str]] | None:
        ...
    ...
    async def watch_transactions(self, code: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | list[object]:
        ...
