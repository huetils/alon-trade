...
def sliding_window(n, seq): # -> zip[Any]:
...
no_pad = ...
def partition(n, seq, pad=...): # -> zip[Any] | zip_longest[Any]:
...
def partition_all(n, seq): # -> Generator[Any, Any, None]:
...
def getter(index): # -> Callable[..., tuple[Any]] | itemgetter[Any] | Callable[..., tuple[()]]:
    ...
...
def diff(*seqs, **kwargs): # -> Generator[Any, Any, None]:
