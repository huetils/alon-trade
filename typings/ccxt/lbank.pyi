...
class lbank(Exchange, ImplicitAPI):
    ...
    def fetch_deposit_address_default(
        self, code: str, params=...
    ) -> DepositAddress: ...
    def fetch_deposit_address_supplement(
        self, code: str, params=...
    ) -> DepositAddress: ...
    def withdraw(
    ...
    def fetch_private_deposit_withdraw_fees(
        self, codes=..., params=...
    ):  # -> dict[Any, Any]:
        ...
    def fetch_public_deposit_withdraw_fees(
        self, codes=..., params=...
    ):  # -> dict[Any, Any]:
        ...
