...
class Exchange:
    ...
    def safe_integer(dictionary, key, default_value=...):  # -> int | None:
        ...
    @staticmethod
    def safe_integer_product(
        dictionary, key, factor, default_value=...
    ):  # -> int | None:
        ...
    @staticmethod
    ...
    def safe_integer_product_2(
        dictionary, key1, key2, factor, default_value=...
    ):  # -> int | None:
        ...
    @staticmethod
    ...
    def safe_integer_n(dictionary, key_list, default_value=...):  # -> int | None:
        ...
    @staticmethod
    def safe_integer_product_n(
        dictionary, key_list, factor, default_value=...
    ):  # -> int | None:
        ...
    @staticmethod
    ...
    def eth_encode_structured_data(domain, messageTypes, message):  # -> bytes:
        ...
    @staticmethod
    def retrieve_stark_account(
        signature, accountClassHash, accountProxyClassHash
    ):  # -> dict[str, Any]:
        ...
    @staticmethod
    def starknet_encode_structured_data(
    ...
    @staticmethod
    def ecdsa(
        request, secret, algorithm=..., hash=..., fixed_length=...
    ):  # -> dict[str, Any]:
        ...
    @staticmethod
    ...
    def omit_zero(self, string_number):  # -> Literal[''] | None:
        ...
    def check_order_arguments(
        self, market, type, side, amount, price, params
    ):  # -> None:
        ...
    ...
    def describe(self):  # -> dict[str, Any]:
        ...
    def safe_bool_n(
        self, dictionaryOrList, keys: List[IndexType], defaultValue: bool = ...
    ):  # -> bool:
        """
        @ignore
    ...
    def safe_bool_2(
        self, dictionary, key1: IndexType, key2: IndexType, defaultValue: bool = ...
    ):  # -> bool:
        """
        @ignore
               safely extract boolean value from dictionary or list
    ...
    def safe_bool(
        self, dictionary, key: IndexType, defaultValue: bool = ...
    ):  # -> bool:
        """
        @ignore
               safely extract boolean value from dictionary or list
    ...
    def safe_dict_n(
        self, dictionaryOrList, keys: List[IndexType], defaultValue: dict = ...
    ):  # -> dict[Any, Any]:
        """
        @ignore
    ...
    def safe_dict(
        self, dictionary, key: IndexType, defaultValue: dict = ...
    ):  # -> dict[Any, Any]:
        """
        @ignore
               safely extract a dictionary from dictionary or list
    ...
    def safe_dict_2(
        self, dictionary, key1: IndexType, key2: str, defaultValue: dict = ...
    ):  # -> dict[Any, Any]:
        """
        @ignore
               safely extract a dictionary from dictionary or list
    ...
    def safe_list_n(
        self, dictionaryOrList, keys: List[IndexType], defaultValue: List[Any] = ...
    ):  # -> List[Any] | list[Any]:
        """
        @ignore
    ...
    def safe_list(
        self, dictionaryOrList, key: IndexType, defaultValue: List[Any] = ...
    ):  # -> List[Any] | list[Any]:
        """
        @ignore
               safely extract an Array from dictionary or list
    ...
    def check_proxy_url_settings(
        self, url: Str = ..., method: Str = ..., headers=..., body=...
    ):  # -> None:
        ...
    ...
    def safe_integer_omit_zero(
        self, obj: object, key: IndexType, defaultValue: Int = ...
    ):  # -> int | None:
        ...
    ...
    def features_generator(self):  # -> None:
        ...
    def features_mapper(
        self, initialFeatures: Any, marketType: Str, subType: Str = ...
    ...
    def get_default_options(self):  # -> dict[str, dict[str, dict[str, str]]]:
        ...
    def safe_ledger_entry(
        self, entry: object, currency: Currency = ...
    ):  # -> dict[str, Any]:
        ...
    def safe_currency_structure(
        self, currency: object
    ):  # -> OrderedDict[Any, Any] | dict[Any, Any]:
        ...
    def safe_market_structure(
        self, market: dict = ...
    ):  # -> OrderedDict[Any, Any] | dict[Any, Any]:
        ...
    ...
    def safe_liquidation(
        self, liquidation: dict, market: Market = ...
    ):  # -> dict[Any, Any]:
        ...
    ...
    def reduce_fees_by_currency(self, fees):  # -> list[Any]:
        ...
    def safe_ticker(
        self, ticker: dict, market: Market = ...
    ):  # -> OrderedDict[Any, Any] | dict[Any, Any]:
        ...
    ...
    def select_network_key_from_networks(
        ...
        ...
    def safe_number_2(
        self, dictionary: object, key1: IndexType, key2: IndexType, d=...
    ):  # -> None:
        ...
    ...
    def parse_leverage_tiers(
        self, response: Any, symbols: List[str] = ..., marketIdKey=...
    ):  # -> dict[Any, Any]:
        ...
    ...
    def safe_position(self, position: dict):  # -> dict[Any, Any]:
        ...
    def parse_positions(
        self, positions: List[Any], symbols: List[str] = ..., params=...
    ...
    def handle_param_string(
        self, params: object, paramName: str, defaultValue: Str = ...
    ):  # -> list[Any]:
        ...
    def handle_param_string_2(
        self, params: object, paramName1: str, paramName2: str, defaultValue: Str = ...
    ):  # -> list[Any]:
        ...
    def handle_param_integer(
        self, params: object, paramName: str, defaultValue: Int = ...
    ):  # -> list[Any]:
        ...
    def handle_param_integer_2(
        self, params: object, paramName1: str, paramName2: str, defaultValue: Int = ...
    ):  # -> list[Any]:
        ...
    def handle_param_bool(
        self, params: object, paramName: str, defaultValue: Bool = ...
    ):  # -> list[Any]:
        ...
    def handle_param_bool_2(
        self, params: object, paramName1: str, paramName2: str, defaultValue: Bool = ...
    ):  # -> list[Any]:
        ...
    ...
    def get_symbols_for_market_type(
        ...
        marketType: Str = ...,
        subType: Str = ...,
        symbolWithActiveStatus: bool = ...,
        symbolWithUnknownStatus: bool = ...,
    ):  # -> list[Any]:
        ...
    def filter_by_array(
        self, objects, key: IndexType, values=..., indexed=...
    ):  # -> dict[Any, Any] | list[Any]:
        ...
    def fetch2(
        self,
    ...
    def parse_trading_view_ohlcv(
        self, ohlcvs, market=..., timeframe=..., since: Int = ..., limit: Int = ...
    ):  # -> list[Any] | list[object]:
        ...
    ...
    def parse_bid_ask(
        ...
        ...
    def safe_currency(
        self, currencyId: Str, currency: Currency = ...
    ):  # -> CurrencyInterface | OrderedDict[Any, Any] | dict[Any, Any]:
        ...
    def safe_market(
        self,
        marketId: Str,
        ...
        delimiter: Str = ...,
        marketType: Str = ...,
    ):  # -> OrderedDict[Any, Any] | dict[Any, Any] | MarketInterface:
        ...
    ...
    def handle_option_and_params(
        self, params: object, methodName: str, optionName: str, defaultValue=...
    ):  # -> list[Any]:
        ...
    ...
    def handle_market_type_and_params(
        self, methodName: str, market: Market = ..., params=..., defaultValue=...
    ):  # -> list[Any]:
        """
        @ignore
    ...
    def handle_sub_type_and_params(
        self, methodName: str, market=..., params=..., defaultValue=...
    ):  # -> list[Any]:
        ...
    def handle_margin_mode_and_params(
        self, methodName: str, params=..., defaultValue=...
    ):  # -> list[Any]:
        """
        @ignore
               :param dict [params]: extra parameters specific to the exchange API endpoint
    ...
    def safe_number(self, obj, key: IndexType, defaultNumber: Num = ...):  # -> None:
        ...
    def safe_number_n(
        self, obj: object, arr: List[IndexType], defaultNumber: Num = ...
    ):  # -> None:
        ...
    ...
    def integer_precision_to_amount(
        self, precision: Str
    ):  # -> LiteralString | Literal['1'] | None:
        """
        @ignore
    ...
    def filter_by_symbol_since_limit(
        self, array, symbol: Str = ..., since: Int = ..., limit: Int = ..., tail=...
    ):  # -> list[Any] | list[object]:
        ...
    def filter_by_currency_since_limit(
        self, array, code=..., since: Int = ..., limit: Int = ..., tail=...
    ):  # -> list[Any] | list[object]:
        ...
    ...
    def parse_funding_rates(
        self, response, symbols: Strings = ...
    ):  # -> dict[Any, Any] | list[Any]:
        ...
    ...
    def parse_deposit_withdraw_fees(
        self, response, codes: Strings = ..., currencyIdKey=...
    ):  # -> dict[Any, Any]:
        """
        @ignore
    ...
    def parse_incomes(
        self, incomes, market=..., since: Int = ..., limit: Int = ...
    ):  # -> list[Any] | list[object]:
        """
        @ignore
    ...
    def create_ohlcv_object(
        self, symbol: str, timeframe: str, data
    ):  # -> dict[Any, Any]:
        ...
    def handle_max_entries_per_request_and_params(
        self, method: str, maxEntriesPerRequest: Int = ..., params=...
    ):  # -> list[Any]:
        ...
    ...
    def remove_repeated_elements_from_array(self, input):  # -> list[Any]:
        ...
    def handle_until_option(
        self, key: str, request, params, multiplier=...
    ):  # -> list[Any]:
        ...
    def safe_open_interest(
        self, interest: dict, market: Market = ...
    ):  # -> OrderedDict[Any, Any] | dict[Any, Any]:
        ...
    ...
    def parse_option_chain(
        self, response: List[object], currencyKey: Str = ..., symbolKey: Str = ...
    ):  # -> dict[Any, Any]:
        ...
