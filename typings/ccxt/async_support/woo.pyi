...
class woo(Exchange, ImplicitAPI):
    ...
    async def create_trailing_amount_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = ..., trailingAmount=..., trailingTriggerPrice=..., params=...) -> Order:
        """
    ...
    async def create_trailing_percent_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = ..., trailingPercent=..., trailingTriggerPrice=..., params=...) -> Order:
        """
    ...
    async def cancel_all_orders(self, symbol: Str = ..., params=...): # -> Any | list[OrderedDict[Any, Any] | dict[Any, Any]]:
        """
    ...
    async def cancel_all_orders_after(self, timeout: Int, params=...): # -> list[OrderedDict[Any, Any] | dict[Any, Any]]:
        """
