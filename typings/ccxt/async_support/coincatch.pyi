...
class coincatch(Exchange, ImplicitAPI):
    ...
    async def fetch_open_spot_orders(
        self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...
    ) -> List[Order]:
        """
        @ignore
    ...
    async def fetch_open_swap_orders(
        self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...
    ) -> List[Order]:
        """
        @ignore
    ...
    async def fetch_canceled_and_closed_spot_orders(
        self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...
    ) -> List[Order]:
        """
        @ignore
    ...
    async def fetch_canceled_and_closed_swap_orders(
        self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...
    ) -> List[Order]:
        """
        @ignore
    ...
    async def fetch_positions_for_symbol(
        self, symbol: str, params=...
    ) -> List[Position]:
        """
