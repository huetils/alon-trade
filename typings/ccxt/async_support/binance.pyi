...
class binance(Exchange, ImplicitAPI):
    ...
    def parse_balance_custom(
        self, response, type=..., marginMode=..., isPortfolioMargin=...
    ) -> Balances: ...
    ...
    async def futures_transfer(
        self, code: str, amount, type, params=...
    ):  # -> TransferEntry:
        """
        @ignore
    ...
    def calculate_rate_limiter_cost(
        ...
        ...
    async def request(
        self, path, api=..., method=..., params=..., headers=..., body=..., config=...
    ):  # -> None:
        ...
    ...
    async def fetch_open_interest(
        self, symbol: str, params=...
    ):  # -> object | OrderedDict[Any, Any] | dict[Any, Any] | None:
        """
    ...
    async def fetch_trading_limits(
        self, symbols: Strings = ..., params=...
    ):  # -> dict[Any, Any]:
        ...
