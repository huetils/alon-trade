...
class bybit(Exchange, ImplicitAPI):
    ...
    async def is_unified_enabled(
        self, params=...
    ):  # -> list[bool] | list[Any | bool | dict[str, dict[str, str]]]:
        """
    ...
    async def fetch_orders_classic(
        self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...
    ) -> List[Order]:
        """
    ...
    async def fetch_derivatives_open_interest_history(
        self, symbol: str, timeframe=..., since: Int = ..., limit: Int = ..., params=...
    ):  # -> list[Any] | list[object]:
        ...
    ...
    async def fetch_derivatives_market_leverage_tiers(
        self, symbol: str, params=...
    ) -> List[LeverageTier]: ...
    ...
    def parse_liquidation(
        ...
        ...
    async def get_leverage_tiers_paginated(
        self, symbol: Str = ..., params=...
    ):  # -> list[Any] | list[object] | List[Any]:
        ...
    ...
    def parse_leverage_tiers(
        self, response, symbols: Strings = ..., marketIdKey=...
    ) -> LeverageTiers: ...
