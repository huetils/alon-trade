...
class wavesexchange(Exchange, ImplicitAPI):
    ...
    def set_sandbox_mode(self, enabled):  # -> None:
        ...
    async def get_fees_for_asset(
        self, symbol: str, side, amount, price, params=...
    ):  # -> Any:
        ...
    async def custom_calculate_fee(
        self, symbol: str, type, side, amount, price, takerOrMaker=..., params=...
    ):  # -> dict[str, Any]:
        ...
    ...
    def parse_order_book_side(
        self, bookSide, market=..., limit: Int = ...
    ):  # -> list[Any]:
        ...
    ...
    def get_asset_id(self, currencyId):  # -> Literal['']:
        ...
    def to_real_currency_amount(
        self, code: str, amount: float, networkCode=...
    ):  # -> int:
        ...
