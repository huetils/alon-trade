...
class coinbase(Exchange, ImplicitAPI):
 ...
 @ignore
    ...
    def fetch_markets_v3(self, params=...): # -> list[Any]:
        ...
    ...
    def fetch_tickers_v2(self, symbols: Strings = ..., params=...): # -> dict[Any, Any] | list[Any]:
        ...
    
    def fetch_tickers_v3(self, symbols: Strings = ..., params=...): # -> dict[Any, Any] | list[Any]:
        ...
