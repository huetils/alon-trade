...
class hyperliquid(ccxt.async_support.hyperliquid):
    ...
    def handle_error_message(self, client: Client, message):  # -> Literal[False]:
        ...
    def handle_order_book_unsubscription(
        self, client: Client, subscription: dict
    ):  # -> None:
        ...
    def handle_trades_unsubscription(
        self, client: Client, subscription: dict
    ):  # -> None:
        ...
    def handle_tickers_unsubscription(
        self, client: Client, subscription: dict
    ):  # -> None:
        ...
    def handle_ohlcv_unsubscription(
        self, client: Client, subscription: dict
    ):  # -> None:
        ...
