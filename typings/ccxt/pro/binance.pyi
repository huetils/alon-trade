...
class binance(ccxt.async_support.binance):
    ...
    def request_id(self, url):  # -> float | int:
        ...
    def stream(
        self, type: Str, subscriptionHash: Str, numSubscriptions=...
    ):  # -> str | None:
        ...
    ...
    def handle_tickers(self, client: Client, message):  # -> None:
        ...
    def handle_tickers_and_bids_asks(
        self, client: Client, message, methodType
    ):  # -> None:
        ...
    def get_message_hash(
        self, channelName: str, symbol: Str, isBidAsk: bool
    ):  # -> str:
        ...
    ...
    def set_balance_cache(
        self, client: Client, type, isPortfolioMargin=...
    ):  # -> None:
        ...
    async def load_balance_snapshot(
        self, client, messageHash, type, isPortfolioMargin
    ):  # -> None:
        ...
    ...
    def handle_balance(self, client: Client, message):  # -> None:
        ...
    def get_market_type(
        self, method, market, params=...
    ):  # -> Literal['future', 'delivery']:
        ...
    ...
    def set_positions_cache(
        self, client: Client, type, symbols: Strings = ..., isPortfolioMargin=...
    ):  # -> None:
        ...
