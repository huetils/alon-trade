...
class gate(ccxt.async_support.gate):
    ...
    async def subscribe_watch_tickers_and_bids_asks(
        self, symbols: Strings = ..., callerMethodName: Str = ..., params=...
    ) -> Tickers: ...
    def handle_ticker_and_bid_ask(
        self, objectName: str, client: Client, message
    ):  # -> None:
        ...
    ...
    def get_type_by_market(
        self, market: Market
    ):  # -> Literal['spot', 'options', 'futures']:
        ...
    ...
    async def subscribe_public(
        self, url, messageHash, payload, channel, params=..., subscription=...
    ): ...
    async def subscribe_public_multiple(
        self, url, messageHashes, payload, channel, params=...
    ): ...
    ...
    async def subscribe_private(
        self, url, messageHash, payload, channel, params, requiresUid=...
    ): ...
