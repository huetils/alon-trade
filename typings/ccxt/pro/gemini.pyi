...
class gemini(ccxt.async_support.gemini):
    ...
    def handle_trades(self, client: Client, message):  # -> None:
        ...
    def handle_trades_for_multidata(
        self, client: Client, trades, timestamp: Int
    ):  # -> None:
        ...
    ...
    def handle_bids_asks_for_multidata(
        self, client: Client, rawBidAskChanges, timestamp: Int, nonce: Int
    ):  # -> None:
        ...
    async def helper_for_watch_multiple_construct(
        self, itemHashName: str, symbols: List[str], params=...
    ): ...
    def handle_order_book_for_multidata(
        self, client: Client, rawOrderBookChanges, timestamp: Int, nonce: Int
    ):  # -> None:
        ...
