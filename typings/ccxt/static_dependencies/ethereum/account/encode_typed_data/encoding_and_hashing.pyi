...
def encode_field(
    types: Dict[str, List[Dict[str, str]]], name: str, type_: str, value: Any
...
def encode_data(
    type_: str, types: Dict[str, List[Dict[str, str]]], data: Dict[str, Any]
) -> bytes: ...
def hash_struct(
    type_: str, types: Dict[str, List[Dict[str, str]]], data: Dict[str, Any]
) -> bytes: ...
def hash_eip712_message(
    message_types: Dict[str, List[Dict[str, str]]], message_data: Dict[str, Any]
) -> bytes: ...
