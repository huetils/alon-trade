...
class VerifyingKey:
    ...
    @classmethod
    def from_string(
        klass, string, curve=..., hashfunc=..., validate_point=...
    ):  # -> Self:
        ...
    @classmethod
    ...
    def from_public_key_recovery(
        klass, signature, data, curve, hashfunc=..., sigdecode=...
    ):  # -> list[Self]:
        ...
    @classmethod
    def from_public_key_recovery_with_digest(
        klass, signature, digest, curve, hashfunc=..., sigdecode=...
    ):  # -> list[Self]:
        ...
...
class SigningKey:
    ...
    def sign_deterministic(
        self, data, hashfunc=..., sigencode=..., extra_entropy=...
    ): ...
    def sign_digest_deterministic(
        self, digest, hashfunc=..., sigencode=..., extra_entropy=...
    ):
        """
