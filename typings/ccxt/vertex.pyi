...
from ccxt.base.types import Balances, Currencies, Currency, FundingRate, FundingRates, Int, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction
...
class vertex(Exchange, ImplicitAPI):
    ...
    def cancel_orders(self, ids: List[str], symbol: Str = ..., params=...): # -> Any:
        """
    ...
    def query_nonces(self): # -> dict[Any, Any]:
        ...
