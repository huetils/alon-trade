...
class kraken(Exchange, ImplicitAPI):
    ...
    def safe_currency(
        self, currencyId, currency: Currency = ...
    ...
    def fetch_ledger_entries_by_ids(
        self, ids, code: Str = ..., params=...
    ):  # -> list[Any] | list[object]:
        ...
    def fetch_ledger_entry(
    ...
    def find_market_by_altname_or_id(
        self, id
    ...
    def parse_transactions_by_type(
        self, type, transactions, code: Str = ..., since: Int = ..., limit: Int = ...
    ):  # -> list[Any] | list[object]:
        ...
    def fetch_deposits(
        self, code: Str = ..., since: Int = ..., limit: Int = ..., params=...
