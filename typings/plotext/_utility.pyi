...
def turn_gray(
    matrix,
):  # -> list[list[tuple[int, ...] | tuple[Literal[127], Literal[127], Literal[127]]]]:
    ...
...
def bars(x, y, width, minimum):  # -> tuple[list[Any], list[Any]]:
    ...
def set_multiple_bar_data(
    *args,
):  # -> tuple[list[int] | Any, list[Any | list[Any]] | list[Any]]:
    ...
def hist_data(
    data, bins=..., norm=...
):  # -> tuple[list[Any | float | int], list[float] | list[int]]:
    ...
def single_bar(x, y, ylabel, marker, colors): ...
def bar_data(
    *args, width=..., mode=...
):  # -> tuple[list[str], list[int] | list[Any | list[Any]] | list[Any], list[list[Any]], int]:
    ...
