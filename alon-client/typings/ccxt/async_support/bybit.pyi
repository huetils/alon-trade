...
class bybit(Exchange, ImplicitAPI):
    ...
    async def cancel_all_orders(self, symbol: Str = ..., params=...): # -> Any | list[Any] | list[object]:
        """
    ...
    async def fetch_order_classic(self, id: str, symbol: Str = ..., params=...): # -> None:
        """
...
classic accounts only/ spot not supported*  fetches information on an order made by the user *classic accounts only*
    ...
    async def fetch_closed_order(self, id: str, symbol: Str = ..., params=...): # -> None:
        """
    ...
    async def fetch_open_order(self, id: str, symbol: Str = ..., params=...): # -> None:
        """
