...
class coinlist(Exchange, ImplicitAPI):
    ...
    def calculate_rate_limiter_cost(self, api, method, path, params, config=...): # -> int:
        ...
    ...
    async def fetch_canceled_orders(self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> Coroutine[Any, Any, List[Order]]:
        """
