...
class coinbase(Exchange, ImplicitAPI):
 ...
 @ignore
    ...
    async def fetch_tickers_v2(self, symbols: Strings = ..., params=...): # -> dict[Any, Any] | list[Any]:
        ...
    
    async def fetch_tickers_v3(self, symbols: Strings = ..., params=...): # -> dict[Any, Any] | list[Any]:
        ...
