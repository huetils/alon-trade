...
from ccxt.base.types import Balances, Currencies, Currency, FundingRate, FundingRates, Int, LedgerEntry, Leverage, Market, Num, Order, OrderBook, OrderRequest, OrderSide, OrderType, Str, Strings, Trade, TradingFees, Transaction
...
class woofipro(Exchange, ImplicitAPI):
 ...
 @ignore
    ...
    async def cancel_all_orders(self, symbol: Str = ..., params=...): # -> list[dict[str, Any]]:
        """
